...
const Button = ({btnText}) => {
  return (
    <div className='relative min-w-[184px] inline-flex items-center justify-center px-6 py-[18px] overflow-hidden font-medium transition duration-300 ease-out rounded-full shadow-xl group'>
